...
**CyberForce** is a cybersecurity competition hosted by the Department of Energy that allow teams to
defend their infrastructure while being attacked. Teams of 4-6 will have 2-3 weeks to harden their systems and prepare
...
For more information, check out their <a href="https://cyberforce.energy.gov/cyberforce-competition/?">website</a>.

## An Overview of the Competition

The first part of the competition was when our team is given access to the virtual network of machines.
We have used Microsoft Azure in the past, but have recently switched to Amazon Web Services (AWS). These
...
### Hardening
As mentioned above, some machines are not allowed to be touched as this is how red team will perform their
attacks. There are certain machines we will be able to configure (which is great as there's less to worry about)
and we can focus on those. We had about a week to report any vulnerabilities and how we can mitigate them.
...
### Usability
We know about the red team, but what about the green team? In addition to implementing an IDS on the extra
...
As great of opportunities as this competition provides, there are parts where it gets messy. We were given the
machines really late this year and rules/restrictions were constantly being updated, but that's a taste of
the real world.
...
a good amount of time to be allocated for preparation. We are all students with classes and extra-curriculars,
...
competition and setting up a live website with user accounts that fetches the correct information. Splitting up the work
...
they are working harder to provide a better experience for students. The most unique aspect of the
competition was the feedback our team received from the red team after each of the attacks.
Oh, and the anomalies were fun as well.

Feel free to reach out if you have any questions/comments about the experience!
