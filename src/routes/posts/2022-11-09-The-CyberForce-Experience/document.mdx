...
The competition begins by giving the login credentials to the team's respective machines.
...
Here are some (not all) notable things to check during the attacks:
...
* nmap (vulnerability scan for CVEs), Nessus, Splunk, netstat, tcpdump, wireshark
